...
LevelsConfig[0] = {
	...
	Misiones = {
		...
		-- Zona 2: Grado de Nodo (Estrella)
		{
			ID=3,
			Zona="Zona_Estacion_2",
			Texto="Conecta el Centro con Vecino 1",
			Tipo="ARISTA_CREADA",
			Puntos=100,
			Parametros={ NodoA="Nodo1_z2", NodoB="Nodo2_z2" }
		},
		{
			ID=4,
			Zona="Zona_Estacion_2",
			Texto="Conecta el Centro con Vecino 2",
			Tipo="ARISTA_CREADA",
			Puntos=100,
			Parametros={ NodoA="Nodo1_z2", NodoB="Nodo3_z2" }
		},
		{
			ID=5,
			Zona="Zona_Estacion_2",
			Texto="Conecta el Centro con Vecino 3",
			Tipo="ARISTA_CREADA",
			Puntos=100,
			Parametros={ NodoA="Nodo1_z2", NodoB="Nodo4_z2" }
		},
		{
			ID=6,
			Zona="Zona_Estacion_2",
			Texto="Logra que el Centro tenga grado 3",
			Tipo="GRADO_NODO",
			Puntos=200,
			Parametros={ Nodo="Nodo1_z2", GradoRequerido=3 }
		},
		-- Zona 3: Grafos Dirigidos (Camino)
		{
			ID=7,
			Zona="Zona_Estacion_3",
			Texto="Conecta Nodo X con Nodo Y",
		...
		},
		{
			ID=8,
			Zona="Zona_Estacion_3",
			Texto="Conecta Nodo Y con Nodo Z",
			Tipo="ARISTA_DIRIGIDA",
			Puntos=150,
		...
		-- Zona 4: Conectividad (Grafo Conexo)
		{
			...
			Tipo="ARISTA_CREADA",
			Puntos=100,
			Parametros={ NodoA="Nodo1_z4", NodoB="Nodo2_z4" }
		},
		{
			ID=10,
			Zona="Zona_Estacion_4",
			Texto="Conecta Nodo 2 con Nodo 3",
			Tipo="ARISTA_CREADA",
			Puntos=100,
			Parametros={ NodoA="Nodo2_z4", NodoB="Nodo3_z4" }
		},
		{
			ID=11,
			Zona="Zona_Estacion_4",
			Texto="Haz que todos los nodos estén conectados",
			Tipo="GRAFO_CONEXO",
			Puntos=300,
			Parametros={ Nodos={"Nodo1_z4", "Nodo2_z4", "Nodo3_z4", "Nodo4_z4"} }
		},
	},
}
