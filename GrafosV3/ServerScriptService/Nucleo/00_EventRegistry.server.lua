...
local EVENTOS_REMOTOS = {
	...
	{ nombre = "ToggleMapaAbierto",      tipo = "RemoteEvent" },      -- Cliente -> Server (sincronizar estado del mapa)
	...
	{ nombre = "EstadoLamparaEmergencia", tipo = "RemoteEvent" },      -- Server -> Cliente (intensidad lámpara emergencia por zona)
