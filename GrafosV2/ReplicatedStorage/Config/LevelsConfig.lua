...
LevelsConfig[1] = {
	...
	Seccion   = "Búsqueda y Conectividad",
...
LevelsConfig[2] = {
	...
	DescripcionCorta = "Recorre la fábrica aplicando BFS y DFS para procesar señales.",
...
LevelsConfig[3] = {
	...
	DescripcionCorta = "Los puentes tienen dirección. Aprende grafos dirigidos.",
...
LevelsConfig[4] = {
	...
	Algoritmo = "Dijkstra",
	Conceptos = { "Dijkstra", "Peso", "Ruta mínima", "Greedy" },
